"""Synthetic temporal-fusion sandbox used by the Streamlit explainer.

Compares a Beta-prior-regularised rolling score over a Markov-switching latent
process with a fixed single-observation score.  This module is illustrative;
the competition metric source is the executed Notebook 03 result bundle.
...
Classifiers
-----------
- **Prior-regularised temporal score**: a rolling mean shrunk toward a Beta
  prior mean using pseudo-counts.  It is not a calibrated sensor posterior.
...
Because the generated latent process is temporally correlated, smoothing can
outperform a memoryless score in this deliberately controlled sandbox.  No
numeric result from this module should be presented as field performance.
"""
