...
- 总结论：**通过**
- 生成时间：2026-08-12T17:05:52+08:00
...
| 本地 Streamlit 隔离端口真实启动 | 通过 | port=8510; startup=1.629s; health=200/ok; root=200; cleanup=True |
| 本体 Effect→Action→Mission 写回原型 | 通过 | decision=ACT-843B114DD264; rules=8; auto=5; human_gate=3; rdf_triples=129; canonical unchanged |
| Streamlit 唯一主线与部署镜像哈希一致 | 通过 | 34/34 managed files matched |
